...
It is often useful to use a linear regression command that is very quick and very simple. Using such a function might save you a lot of time doing a paralleled simulation study related to simple regression.
